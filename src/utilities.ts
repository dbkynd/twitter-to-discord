...
export function promiseSome(array: Promise<unknown>[]): Promise<any | null[]> {
...
export function createDir(location: string): Promise<void> {
...
function exists(location: string): Promise<string> {
  return new Promise((resolve, reject) => {
...
function makeDir(location: string): Promise<void> {
  return new Promise((resolve, reject) => {
